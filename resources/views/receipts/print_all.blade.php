...
@section('title', 'Cetak Semua Kuitansi')
...
@section('content')
    <style>
        ...
        /* Force page break between receipts */
        .page-break {
    ...
    <div class="page-break" style="font-family: 'Times New Roman', Times, serif; font-size: 8pt; color: #000; border: 1px solid #1f2937; padding: 20px;">
        {{-- Header --}}
